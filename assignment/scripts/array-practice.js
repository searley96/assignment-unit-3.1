...
let foodsArray = ['pizza', 'sushi', 'curry', 'mac and cheese'];
...
let andString = foodsString.replaceAll(",", " and ");
...
let animalFood = foodsArray.concat(animalArray);
